...
const UserDashboardPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>4everStay | UserDashboard</title>
        <meta
          name="description"
          content="User Dashboard to manage their accound, change password, view their review and their hostel listings"
        />
      </Helmet>
      <NotificationBar />
      <NavAndSidebar />
      <Wrapper>
        {user ? <DashboardSidebarUser user={user} /> : null}
        <Content>
