          ...
          <SidebarList>
            ...
            <SidebarListItem to="/user/changepassword">
              <SidebarItemDiv>
                ...
                <SidebarItemText>Change Password</SidebarItemText>
              </SidebarItemDiv>
            </SidebarListItem>
            <SidebarListItem to="/user/reviews">
              <SidebarItemDiv>
                <MdOutlineRateReview style={iconStyle} />
                <SidebarItemText>Reviews</SidebarItemText>
              </SidebarItemDiv>
            </SidebarListItem>

            {user.hostel_listings !== null &&
              user.hostel_listings.length > 0 && (
            ...
            <SidebarListItem to="/user/register/hostel">
              <SidebarItemDiv>
                ...
                <SidebarItemText>Register a Hostel</SidebarItemText>
              </SidebarItemDiv>
            </SidebarListItem>
            <SidebarListItem to="/">
              <SidebarItemDiv>
